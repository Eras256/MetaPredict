...
export const CONTRACT_ADDRESSES: {
  ...
  PREDICTION_MARKET: getAddress(process.env.NEXT_PUBLIC_CORE_CONTRACT_ADDRESS, '0xCB6a24b349c96526B6e7b79a87B2c4009d25D7AC'),
  CORE_CONTRACT: getAddress(process.env.NEXT_PUBLIC_CORE_CONTRACT_ADDRESS, '0xCB6a24b349c96526B6e7b79a87B2c4009d25D7AC'),
  ...
  BINARY_MARKET: getAddress(process.env.NEXT_PUBLIC_BINARY_MARKET_ADDRESS, '0x44bF3De950526d5BDbfaA284F6430c72Ea99163B'),
  CONDITIONAL_MARKET: getAddress(process.env.NEXT_PUBLIC_CONDITIONAL_MARKET_ADDRESS, '0x45E223eAB99761A7E60eF7690420C178FEBD23df'),
  SUBJECTIVE_MARKET: getAddress(process.env.NEXT_PUBLIC_SUBJECTIVE_MARKET_ADDRESS, '0xaBb50827b49E7c725B6A8B735348D3A2a34E70cE'),

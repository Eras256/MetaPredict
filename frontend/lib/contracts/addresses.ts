const getAddress = (envVar: string | undefined, defaultAddr: `0x${string}`): `0x${string}` => {
  ...
  const oldAddresses = [
    ...
    '0x5eaa77CC135b82c254F1144c48f4d179964fA0b1', // Core anterior (intermedio)
    '0xCB6a24b349c96526B6e7b79a87B2c4009d25D7AC', // Core anterior (con bug placeBet)
  ];
...
export const CONTRACT_ADDRESSES: {
  ...
  // Direcciones actualizadas desde el Core Contract desplegado
  // Última actualización: 2025-11-19
  // Core Contract: 0x3Ee41D06739AB1fb90FB6718CE579e84b00FfA99 (con corrección placeBet)
  PREDICTION_MARKET: getAddress(process.env.NEXT_PUBLIC_CORE_CONTRACT_ADDRESS, '0x3Ee41D06739AB1fb90FB6718CE579e84b00FfA99'),
  CORE_CONTRACT: getAddress(process.env.NEXT_PUBLIC_CORE_CONTRACT_ADDRESS, '0x3Ee41D06739AB1fb90FB6718CE579e84b00FfA99'),
